...
echo "  2. Review the plan: Use reviewer agent to review the structure"
echo "  3. Execute tasks: Use tasker agent to work through each phase"
echo "  4. Verify: Use verifier agent to verify completion"
echo ""
