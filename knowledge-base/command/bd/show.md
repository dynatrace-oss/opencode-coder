...
Run `bd show <issue-id>` to retrieve issue details and present them clearly, including:
...
If the issue has dependencies, offer to show the full dependency tree with `bd dep tree <id>`.
