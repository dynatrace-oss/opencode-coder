...
**Note:** The bd CLI automatically checks bd CLI version >= 0.9.0 on startup. This command provides detailed version info and update instructions.

Use the bd CLI tools to:
...
- bd CLI version (0.9.2)
- bd CLI status (from `bd stats` command or connection test)
