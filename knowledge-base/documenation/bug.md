...
2. Whenever you complete a state you ensure that everything is committed. This means if the user agrees to enter the
   next
...
4. ALWAYS commit when you have done a state change to the document: WHENEVER we complete one state and enter a new one
   we
